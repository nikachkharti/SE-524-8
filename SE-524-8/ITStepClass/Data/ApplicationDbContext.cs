...
namespace ITStepClass.Data
{
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            SeedStudentProfiles(modelBuilder);
            SeedStudentSubjects(modelBuilder);
        }
        ...
        private static void SeedStudentSubjects(ModelBuilder modelBuilder)
        {
        ...
        private static void SeedStudentProfiles(ModelBuilder modelBuilder)
        {
        ...
        private static void ConfigureStudentSubjects(ModelBuilder modelBuilder)
        {
        ...
        private static void ConfiureSubjects(ModelBuilder modelBuilder)
        {
            #region SUBJECT
